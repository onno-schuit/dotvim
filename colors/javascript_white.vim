...
hi NonText          guifg=#070707     guibg=white       gui=NONE      ctermfg=white       ctermbg=NONE        cterm=NONE
...
hi Identifier       guifg=#855500     guibg=NONE        gui=NONE      ctermfg=cyan        ctermbg=NONE        cterm=NONE
hi Function         guifg=black       guibg=NONE        gui=bold      ctermfg=brown       ctermbg=NONE        cterm=NONE
hi Type             guifg=black       guibg=NONE        gui=NONE      ctermfg=yellow      ctermbg=NONE        cterm=NONE
hi Statement        guifg=#660066     guibg=NONE        gui=NONE      ctermfg=lightblue   ctermbg=NONE        cterm=NONE

hi Special          guifg=black       guibg=NONE        gui=NONE      ctermfg=black       ctermbg=NONE        cterm=NONE
hi Delimiter        guifg=black       guibg=NONE        gui=bold      ctermfg=cyan        ctermbg=NONE        cterm=NONE
